...
/* TODO: Should probably be a platform argument */
...
void Platform::createInstance() {
    ...
    vkc(vkCreateInstance(&createInfo, nullptr, &instance));
}
...
void Platform::setupDebugMessenger() {
    ...
    vkc(createDebugUtilsMessengerEXT(instance, &createInfo, nullptr, &debugMessenger));
}

std::vector<const char*> Platform::getRequiredExtensions() {
    uint32_t glfwExtensionCount = 0;
    const char** glfwExtensions;
    /* TODO: This should not have a glfw-dependency. We should figure out the required dependencies in the application
     * and then create the platform based on those */
